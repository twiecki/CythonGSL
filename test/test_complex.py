...
class ComplexTest(unittest.TestCase):
  ...
  def test_gsl_complex_rect(self):
    ...
    self.assertAlmostEqual(t[0],1.1, 16)
    self.assertAlmostEqual(t[1],2.2, 16)

  def test_gsl_complex_polar(self):
    t = complex.t_gsl_complex_polar()
    self.assertAlmostEqual(t[0],-1.2, 16)
    self.assertAlmostEqual(t[1], 0, 15)
  ...
  def test_GSL_REAL(self):
    self.assertAlmostEqual(complex.t_GSL_REAL(),0, 16)

  def test_GSL_IMAG(self):
    self.assertAlmostEqual(complex.t_GSL_IMAG(),0, 16)


  def test_GSL_COMPLEX_ONE(self):
    t = complex.t_GSL_COMPLEX_ONE()
    self.assertAlmostEqual(t[0],1, 16)
    self.assertAlmostEqual(t[1],0, 16)

  def test_GSL_COMPLEX_ZERO(self):
    t = complex.t_GSL_COMPLEX_ZERO()
    self.assertAlmostEqual(t[0],0, 16)
    self.assertAlmostEqual(t[1],0, 16)
  ...
  def test_gsl_complex_arg(self):
    self.assertAlmostEqual(complex.t_gsl_complex_arg(),0, 15)

  def test_gsl_complex_abs(self):
    self.assertAlmostEqual(complex.t_gsl_complex_abs(),0, 15)

  def test_gsl_complex_abs2(self):
    self.assertAlmostEqual(complex.t_gsl_complex_abs2(),0, 15)

  def test_gsl_complex_logabs(self):
    self.assertAlmostEqual(complex.t_gsl_complex_logabs(),0, 15)
  ...
  def test_gsl_complex_sub(self):
    ...
    self.assertAlmostEqual(t[0],0, 15)
    self.assertAlmostEqual(t[1],0, 15)
